...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $query = "INSERT INTO transaksi ( id_users, id_pelanggan, tgl_transaksi, total_harga) 
              VALUES ( '$id_users', '$id_pelanggan', '$tgl_transaksi', '$total_harga')";
      ...
      <table>
        ...
        <tbody>
          ...
          <tr>
            ...
            <td><?= htmlspecialchars($item['id_users']); ?></td>
            <td><?= htmlspecialchars($item['id_pelanggan']); ?></td>
            <td><?= htmlspecialchars($item['tgl_transaksi']); ?></td>
